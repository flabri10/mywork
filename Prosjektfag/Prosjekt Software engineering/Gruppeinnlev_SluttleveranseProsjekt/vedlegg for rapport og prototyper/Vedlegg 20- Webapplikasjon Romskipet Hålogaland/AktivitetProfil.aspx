<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AktivitetProfil.aspx.cs" Inherits="AktivitetProfil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" Runat="Server">
    ...
    <asp:Panel ID="pnlAdminInfo" runat="server">
        <div id="deltakerListe">
            ...
            <div id="divAdminInfo">
                ...
                <h3><img src="gfx/cog_small.png" alt="Bruker" />Rediger aktivitet</h3>
                <asp:LinkButton ID="ltbnSendTilProfil" runat="server" Text="Rediger aktiviteten"></asp:LinkButton>
    ...
    <div id="kursBeskrivelseLeft">
        <h3>Beskrivelse</h3>
        <asp:Literal ID="litAktivitetBeskrivelse" runat="server"> </asp:Literal>
    </div>
